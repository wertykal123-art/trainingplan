...
const VERSION = "v3";
const SHELL = ["/", "/index.html", "/style.css", "/app.js", "/shared/program.js", "/shared/cycle.js", "/shared/plan.js", "/manifest.webmanifest", "/icons/icon.svg", "/icons/icon-192.png", "/icons/icon-512.png"];
