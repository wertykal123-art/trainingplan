/* Výchozí tréninkový plán. Od nasazení vlastního plánu z Clauda slouží už jen
   jako záloha pro deníky, které žádný vlastní plán nemají.
   Tvar dokumentu a jeho kontrolu má na starost shared/plan.js. */
...
export const BUILTIN_PLAN = {
  "format": "trenink-plan/1",
  "id": 0,
  "name": "Výchozí plán: síla a zdraví při třech sportech",
  "note": "Tři tréninky týdně, střídá se A → B → C. Bez vertikálního tahu, ten nahrazuje lezení.",
  "order": [
    "A",
    "B",
    "C"
  ...
  "days": {
    "A": {
      ...
      "ex": [
        ...
        {
          "id": "row",
          "name": "Přítah jednoručky v předklonu",
          "sets": 3,
          "lo": 8,
          "hi": 12,
          "inc": 2,
    ...
    "B": {
      "title": "Mrtvý tah & tlak nad hlavu",
      "ex": [
        {
          "id": "dead",
          "name": "Mrtvý tah (trhačky / trap bar)",
          "sets": 3,
          "lo": 3,
          "hi": 5,
          "inc": 5,
        ...
        {
          "id": "extrot",
          "name": "Vnější rotace (kladka / guma)",
          "sets": 2,
          "lo": 12,
          "hi": 15,
          "inc": 1.25,
    ...
    "C": {
      ...
      "ex": [
        ...
        {
          "id": "fly",
          "name": "Rozpažky na kladce / peck deck",
          "sets": 3,
          "lo": 12,
          "hi": 15,
          "inc": 2.5,
        ...
        {
          "id": "chestrow",
          "name": "Přítah v podporu na lavici",
          "sets": 3,
          "lo": 10,
          "hi": 12,
          "inc": 2,
        ...
        {
          "id": "triext",
          "name": "Triceps nad hlavu (kladka / jednoručka)",
          "sets": 2,
          "lo": 10,
          "hi": 12,
          "inc": 2.5,
